<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
            ...
            <form method="GET" action="{{ route('sitasi_luaran_pd') }}" class="flex flex-col md:flex-row md:items-center gap-2">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 border">
                                <a href="{{ route('sitasi_luaran_pd', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama Prodi</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('sitasi_luaran_pd', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('sitasi_luaran_pd', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Judul Artikel</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('sitasi_luaran_pd', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Jumlah Sitasi</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('sitasi_luaran_pd', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Link Sitasi</a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($sitasi_luaran_pd as $data)
                            <tr>
