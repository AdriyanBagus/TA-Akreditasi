<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
            ...
            <form method="GET" action="{{ route('profil_dosen') }}" class="flex flex-col md:flex-row md:items-center gap-2">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama
                                    Prodi</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama
                                    Dosen</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">NIDN</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Kualifikasi
                                    pendidikan</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Sertifikat
                                    pendidik profesional</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('profil_dosen', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Bidang
                                    Keahlian</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
