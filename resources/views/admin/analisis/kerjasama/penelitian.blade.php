        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                    ...
                    <thead>
                        ...
                        <th class="px-4 py-2 border">No</th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('penelitian', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama Prodi</a>
                            </th>
                            <th class="px-4 py-2 border">Lembaga Mitra</th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('penelitian', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Tingkat</a>
                            </th>
                            <th class="px-4 py-2 border">Judul Kegiatan</th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('penelitian', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Waktu/Durasi</a>
                            </th>
                            <th class="px-4 py-2 border">Realisasi Kerjasama</th>
                            <th class="px-4 py-2 border">
                                <a href="{{ route('penelitian', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">SPK</a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                @if($penelitian->isEmpty())
                    <p class="text-center text-gray-500 mt-4">Tidak ada Kerjasama Penelitian yang terdaftar.</p>
                @endif
            </div>
        </div>
    </div>
