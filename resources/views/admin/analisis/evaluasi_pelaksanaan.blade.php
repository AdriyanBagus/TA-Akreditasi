                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama
                                    Prodi</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nomer
                                    PTK</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Kategori
                                    PTK</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Rencana
                                    Penyelesaian</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Realisasi
                                    Perbaikan</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('evaluasi_pelaksanaan', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Penanggung
                                    Jawab Perbaikan</a>
                            </th>
                        </tr>
                    </thead>
