<x-app-layout>
    ...
    <div class="py-12">
        ...
        <form action="{{ route('ketersediaan_dokumen.export.csv') }}" method="GET" class="mb-4">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('ketersediaan_dokumen', ['sort_by' => 'nama_user', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Nama
                                    Prodi</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('ketersediaan_dokumen', ['sort_by' => 'visi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">Kegiatan</a>
                            </th>
                            <th class="px-4 py-2 border">
                                <a
                                    href="{{ route('ketersediaan_dokumen', ['sort_by' => 'misi', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc']) }}">ketersediaan
                                    dokumen</a>
                            </th>
