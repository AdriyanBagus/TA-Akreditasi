                        ...
                        @foreach($profil_dosen as $profildosen)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('dosen.profil_dosen.destroy', $profildosen->id) }}" method="POST"
                                            ...
                                            <form action="{{ route('dosen.profil_dosen.update', $profildosen->id) }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nama" name="nama"
                                                        value="{{ $profildosen->nama }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="nidn" class="form-label">NIDN:</label>
                                                    <input type="text" class="form-control" id="nidn" name="nidn"
                                                        value="{{ $profildosen->nidn }}" required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="sertifikasi_pendidik_profesional"
                                                        name="sertifikasi_pendidik_profesional"
                                                        value="{{ $profildosen->sertifikasi_pendidik_profesional }}"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="bidang_keahlian" class="form-label">Bidang Keahlian:</label>
                                                    <input type="text" class="form-control" id="bidang_keahlian"
                                                        name="bidang_keahlian" value="{{ $profildosen->bidang_keahlian }}"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="bidang_ilmu_prodi" class="form-label">Bidang Ilmu
                                                        Prodi:</label>
                                                    <input type="text" class="form-control" id="bidang_ilmu_prodi"
                                                        name="bidang_ilmu_prodi"
                                                        value="{{ $profildosen->bidang_ilmu_prodi }}" required>
                                                </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('dosen.profil_dosen.store') }}" method="POST">
                                    @csrf

                                    <div class="mb-3">
                                        <label for="asal_prodi" class="form-label">Asal Prodi:</label>
                                        <select class="form-control" id="asal_prodi" name="asal_prodi" required>
                                    ...
                                    @if(!Auth::user()->dosen)
                                        <p class="text-danger">Data dosen untuk user ini belum tersedia. Silakan hubungi
                                            admin.</p>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        <label for="sertifikasi_pendidik_profesional" class="form-label">Sertifikasi
                                            Profesional:</label>
                                        <input type="text" class="form-control" id="sertifikasi_pendidik_profesional"
                                            name="sertifikasi_pendidik_profesional"
                                            value="{{ session('sertifikasi_pendidik_profesional') }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="bidang_keahlian" class="form-label">Bidang Keahlian:</label>
                                        <input type="text" class="form-control" id="bidang_keahlian"
                                            name="bidang_keahlian" value="{{ session('bidang_keahlian') }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="bidang_ilmu_prodi" class="form-label">Bidang Ilmu Prodi:</label>
                                        <input type="text" class="form-control" id="bidang_ilmu_prodi"
                                            name="bidang_ilmu_prodi" value="{{ session('bidang_ilmu_prodi') }}"
                                            required>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
