<x-app-layout>
        ...
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                <table class="min-w-full bg-white border border-gray-500">
                    ...
                    <tbody>
                        @foreach($sitasi_luaran_pkm_dosen as $sitasiluaran)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('pages.sitasi_luaran_pkm_dosen.destroy', $sitasiluaran->id) }}" method="POST"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('pages.sitasi_luaran_pkm_dosen.update', $sitasiluaran->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('pages.sitasi_luaran_pkm_dosen.add') }}" method="POST">
                                    @csrf
    ...
    <script>
        document.getElementById('exampleModal').addEventListener('show.bs.modal', function (event) {
         ...
         modalTitle.textContent = 'Tambah Sitasi luaran PKM Dosen ';
