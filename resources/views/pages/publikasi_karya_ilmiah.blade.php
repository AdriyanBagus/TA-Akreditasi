                        ...
                        @foreach($publikasi_karya_ilmiah as $publikasi)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('pages.publikasi_karya_ilmiah.destroy', $publikasi->id) }}" method="POST"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('pages.publikasi_karya_ilmiah.update', $publikasi->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
